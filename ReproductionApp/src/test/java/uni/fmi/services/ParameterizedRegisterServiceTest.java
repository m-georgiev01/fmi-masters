...
import uni.fmi.repository.UserRepository;
...
public class ParameterizedRegisterServiceTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {null, "123123", "123123", "martin11l@gmail.com", "Invalid username\n", 0},
                {"12", "123123", "123123", "martin1111@gmail.com", "Invalid username\n", 0},
                {
                ...
                {"martin2001", "123123", "123123", null,"Invalid email\n", 0},
                {"martin", null, "321321", "martin11@gmail.com","Invalid password\n", 0},
                {"martin", "1231231", "123123", "martin11111@gmail.com","Passwords do not match\n", 0},
                {"martin", "123123", "123123", "martin@gmail.com","User successfully registered", 1},
                {EXISTING_USERNAME, "123123", "123123", "martin@gmail.com","User with this username already exists\n", 0},
                {"martin", "123123", "123123", EXISTING_EMAIL,"User with this email already exists\n", 0}
        });
    }
